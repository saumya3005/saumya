...
export default function ServicesSection() {
  ...
  return (
    <section id="services" className="py-24 sm:py-32 bg-luxury-bg text-white relative border-t border-accent-copper/20 overflow-hidden">
      <motion.div ref={containerRef} style={{ y: yShift }} className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        {/* Services List */}
        <div className="flex flex-col border-t border-accent-copper/25">
          {SERVICES_DATA.map((service, idx) => (
            <motion.div
              ...
              className="group border-b border-accent-copper/25 relative overflow-hidden"
            >
              ...
              <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between p-8 sm:py-12 sm:px-8 gap-6 group-hover:px-12 transition-all duration-500">
                <div className="flex items-start md:items-center gap-6 md:gap-12 w-full md:w-auto">
                  <span className="text-xl sm:text-2xl font-mono text-secondary-text group-hover:text-yellow-900 transition-colors duration-500">
                    {service.number}
                  </span>
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-12 md:w-1/2 justify-between">
                  <p className="text-secondary-text group-hover:text-yellow-900/80 transition-colors duration-500 max-w-sm text-sm sm:text-base font-light">
                    {service.desc}
                  </p>
                  <div className="w-12 h-12 rounded-full border border-accent-copper/25 flex items-center justify-center text-white group-hover:border-zinc-950/20 group-hover:bg-luxury-bg group-hover:text-yellow-500 transition-all duration-500 -rotate-45 group-hover:rotate-0">
